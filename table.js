...
for (const suit of suits) {
  ...
  hitButton.addEventListener("click", dealRandomCard);const mapRanksToWords = {
    2: "Two",
    3: "Three",
    4: "Four",
    5: "Five",
  ...
  function dealToDisplay(card) {
    ...
    newCard.innerText = `${rankToWord(card.rank)} of ${suitToWord(card.suit)}`; const playersCardList = document.querySelector("#playersCards ol");
